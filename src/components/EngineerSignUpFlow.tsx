...
const EngineerSignUpFlow: React.FC<EngineerSignUpFlowProps> = ({ isOpen, onClose, onComplete, initialData, initialStep = 1 }) => {
  ...
  const isStepValid = (stepNum: number = step) => {
    switch (stepNum) {
      ...
      case 8: {
        const isPhoneValid = formData.phoneCountryCode && formData.phoneNumber && validatePhoneNumber(formData.phoneCountryCode.value, formData.phoneNumber);
        const isWhatsappValid = !formData.whatsappNumber || (formData.whatsappCountryCode && validatePhoneNumber(formData.whatsappCountryCode.value, formData.whatsappNumber));
                ...
                {step === 8 && (
                  <div className="space-y-8">
                    <div className="group">
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1 flex gap-3">
                          ...
                          <input 
                            ...
                            className={`flex-1 bg-slate-50 border rounded-2xl px-6 text-lg outline-none focus-visible:ring-2 focus-visible:ring-brand-teal transition-all placeholder:text-slate-300 ${
                              formData.phoneCountryCode && formData.phoneNumber && !validatePhoneNumber(formData.phoneCountryCode.value, formData.phoneNumber)
                      ...
                      {formData.phoneCountryCode && formData.phoneNumber && !validatePhoneNumber(formData.phoneCountryCode.value, formData.phoneNumber) && (
                        <p className="mt-2 text-xs text-red-500 ml-18">
                          Invalid phone number length for {formData.phoneCountryCode.value}. 
                          Expected {Array.isArray(PHONE_LENGTHS[formData.phoneCountryCode.value]) 
                            ? (PHONE_LENGTHS[formData.phoneCountryCode.value] as number[]).join(' or ') 
                            : (PHONE_LENGTHS[formData.phoneCountryCode.value] || '7-15')} digits.
                        </p>
                      )}
                    </div>
                    ...
                    <div className="group">
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1 flex gap-3">
                          ...
                          <input 
                            ...
                            className={`flex-1 bg-slate-50 border rounded-2xl px-6 text-lg outline-none focus-visible:ring-2 focus-visible:ring-brand-teal transition-all placeholder:text-slate-300 ${
                              formData.whatsappCountryCode && formData.whatsappNumber && !validatePhoneNumber(formData.whatsappCountryCode.value, formData.whatsappNumber)
                                ? 'border-red-500 focus-visible:ring-red-500'
                                : 'border-slate-200'
                            }`} 
                          />
                      ...
                      {formData.whatsappCountryCode && formData.whatsappNumber && !validatePhoneNumber(formData.whatsappCountryCode.value, formData.whatsappNumber) && (
                        <p className="mt-2 text-xs text-red-500 ml-18">
                          Invalid WhatsApp number length for {formData.whatsappCountryCode.value}. 
                          Expected {Array.isArray(PHONE_LENGTHS[formData.whatsappCountryCode.value]) 
                            ? (PHONE_LENGTHS[formData.whatsappCountryCode.value] as number[]).join(' or ') 
                            : (PHONE_LENGTHS[formData.whatsappCountryCode.value] || '7-15')} digits.
                        </p>
                      )}
                    </div>
                        ...
                        <div className="flex-1 text-center md:text-left">
                          ...
                          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-6 text-left">
                            <div className="flex gap-3">
                              ...
                              <div>
                                <h4 className="text-sm font-bold text-amber-900 mb-0.5">Email Verification Required</h4>
                                <p className="text-[11px] text-amber-700 leading-relaxed">After completing this step, we will send a verification link to your email. You must verify your email to activate your profile and start receiving jobs.</p>
                              </div>
                            </div>
                          </div>
