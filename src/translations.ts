...
6. Your Rights: You have the right to access, correct, or delete your personal information at any time through your account settings.`
      ...
      cookies: {
        title: "Cookie Policy",
        lastUpdated: "Last updated: October 2023",
        content: `This Cookie Policy explains how Desknet uses cookies and similar technologies to recognize you when you visit our platform.
...
- Essential cookies: Strictly necessary to provide you with services available through our platform.
- Performance and functionality cookies: Used to enhance the performance and functionality of our platform but are non-essential to their use.
- Analytics and customization cookies: Collect information that is used either in aggregate form to help us understand how our platform is being used or how effective our marketing campaigns are.

4. How can I control cookies? You have the right to decide whether to accept or reject cookies. You can set or amend your web browser controls to accept or refuse cookies. If you choose to reject cookies, you may still use our website though your access to some functionality and areas of our website may be restricted.`
      },
    ...
    news: {
      ...
      subtitle: "Stay updated with the latest trends, breakthroughs, and insights from the world of technology and global IT talent.",
      readMore: "Read More",
      ...
      items: [
        {
          id: 1,
          title: "AI Breakthrough: Autonomous Coding Agents",
          excerpt: "New AI models are now capable of handling complex software architecture tasks, reducing development time by 40%.",
          date: "April 5, 2026",
          category: "AI & ML",
          image: "https://picsum.photos/seed/ai-coding/800/600",
          content: "The landscape of software development is undergoing a seismic shift with the introduction of autonomous coding agents. These advanced AI models don't just suggest snippets of code; they can understand entire project architectures, refactor legacy systems, and even debug complex race conditions that human developers might miss. Industry experts predict that by 2027, over 60% of routine coding tasks will be handled by these AI assistants, allowing human engineers to focus on high-level design and strategic problem-solving."
        },
        {
          id: 2,
          title: "The Future of Global Remote Work in 2026",
          excerpt: "Remote work has evolved into a 'Global First' approach, where talent location is secondary to skill and cultural fit.",
          date: "April 2, 2026",
          category: "Remote Work",
          image: "https://picsum.photos/seed/remote-work/800/600",
          content: "As we move further into 2026, the concept of 'remote work' has matured into a sophisticated 'Global First' strategy. Companies are no longer just hiring remotely to save costs; they are doing it to access the absolute best talent regardless of borders. Desknet's latest data shows a 45% increase in cross-continental engineering teams. The key to success in this environment is asynchronous communication and robust digital infrastructure that bridges the gap between time zones."
        },
        {
          id: 3,
          title: "Quantum Computing Hits the Cloud",
          excerpt: "Major cloud providers are now offering quantum-as-a-service, opening new doors for cryptography and optimization.",
          date: "March 28, 2026",
          category: "Cloud Computing",
          image: "https://picsum.photos/seed/quantum/800/600",
          content: "Quantum computing is no longer confined to research labs. This month, major cloud providers announced the general availability of quantum-as-a-service (QaaS). This allows enterprises to run complex optimization algorithms and simulate molecular structures at speeds previously thought impossible. While we are still in the early stages of the 'Quantum Era', the implications for cryptography, financial modeling, and drug discovery are profound."
        },
        {
          id: 4,
          title: "Cybersecurity: The Zero-Trust Mandate",
          excerpt: "With the rise of sophisticated phishing attacks, Zero-Trust architecture has become a requirement for all enterprises.",
          date: "March 25, 2026",
          category: "Security",
          image: "https://picsum.photos/seed/security/800/600",
          content: "In an era where perimeter-based security is no longer sufficient, Zero-Trust architecture has emerged as the gold standard. The 'never trust, always verify' principle is now being applied at every layer of the enterprise stack. From biometric hardware keys to AI-driven anomaly detection, companies are investing heavily to protect their data in an increasingly hostile digital environment. Desknet ensures all its verified engineers are trained in the latest security protocols to maintain this standard."
        }
      ]
    }
  },
...
6. Ваши права: Вы имеете право на доступ, исправление или удаление вашей личной информации в любое время через настройки вашей учетной записи.`
      ...
      cookies: {
        ...
        lastUpdated: "Последнее обновление: Октябрь 2023",
        content: `Эта Политика использования файлов cookie объясняет, как Desknet использует файлы cookie и аналогичные технологии для вашего распознавания при посещении нашей платформы.

1. Что такое файлы cookie? Файлы cookie — это небольшие файлы данных, которые размещаются на вашем компьютере или мобильном устройстве при посещении веб-сайта. Они широко используются владельцами веб-сайтов для обеспечения работы их сайтов или повышения эффективности их работы, а также для предоставления отчетной информации.

2. Почему мы используем файлы cookie? Мы используем собственные и сторонние файлы cookie по нескольким причинам. Некоторые файлы cookie необходимы по техническим причинам для работы нашей платформы, и мы называем их «основными» или «строго необходимыми». Другие файлы cookie также позволяют нам отслеживать и ориентироваться на интересы наших пользователей, чтобы улучшить опыт работы на нашей платформе.

3. Типы файлов cookie, которые мы используем:
- Основные файлы cookie: Строго необходимы для предоставления вам услуг, доступных через нашу платформу.
- Файлы cookie для повышения производительности и функциональности: Используются для улучшения производительности и функциональности нашей платформы, но не являются обязательными для их использования.
- Аналитические и настроечные файлы cookie: Собирают информацию, которая используется либо в совокупной форме, чтобы помочь нам понять, как используется наша платформа или насколько эффективны наши маркетинговые кампании.

4. Как я могу контролировать файлы cookie? У вас есть право решать, принимать или отклонять файлы cookie. Вы можете установить или изменить настройки своего веб-браузера, чтобы принимать или отклонять файлы cookie. Если вы решите отклонить файлы cookie, вы все равно сможете использовать наш веб-сайт, хотя ваш доступ к некоторым функциям и разделам нашего веб-сайта может быть ограничен.`
      },
    ...
    news: {
      tag: "Последние обновления",
      title: "Новости IT и",
      titleAccent: "Инсайты",
      subtitle: "Будьте в курсе последних тенденций, прорывов и идей из мира технологий и глобальных IT-талантов.",
      ...
      items: [
        {
          id: 1,
          title: "Прорыв в ИИ: Автономные агенты кодирования",
          excerpt: "Новые модели ИИ теперь способны решать сложные задачи архитектуры ПО, сокращая время разработки на 40%.",
          date: "5 апреля 2026 г.",
          category: "ИИ и МО",
          image: "https://picsum.photos/seed/ai-coding/800/600",
          content: "Ландшафт разработки программного обеспечения претерпевает сейсмический сдвиг с внедрением автономных агентов кодирования. Эти передовые модели ИИ не просто предлагают фрагменты кода; они могут понимать архитектуру всего проекта, проводить рефакторинг устаревших систем и даже отлаживать сложные условия гонки, которые могут пропустить разработчики-люди. Эксперты отрасли предсказывают, что к 2027 году более 60% рутинных задач по кодированию будут выполняться этими ИИ-помощниками, что позволит инженерам сосредоточиться на высокоуровневом проектировании и стратегическом решении проблем."
        },
        {
          id: 2,
          title: "Будущее глобальной удаленной работы в 2026 году",
          excerpt: "Удаленная работа превратилась в подход 'Global First', где местоположение таланта вторично по отношению к навыкам.",
          date: "2 апреля 2026 г.",
          category: "Удаленная работа",
          image: "https://picsum.photos/seed/remote-work/800/600",
          content: "По мере того как мы продвигаемся в 2026 год, концепция 'удаленной работы' превратилась в сложную стратегию 'Global First'. Компании больше не просто нанимают удаленно для экономии средств; они делают это, чтобы получить доступ к абсолютно лучшим талантам независимо от границ. Последние данные Desknet показывают 45-процентный рост межконтинентальных инженерных команд. Ключом к успеху в этой среде является асинхронная коммуникация и надежная цифровая инфраструктура, которая устраняет разрыв между часовыми поясами."
        },
        {
          id: 3,
          title: "Квантовые вычисления приходят в облако",
          excerpt: "Крупные облачные провайдеры теперь предлагают квантовые вычисления как сервис, открывая новые двери для криптографии.",
          date: "28 марта 2026 г.",
          category: "Облачные вычисления",
          image: "https://picsum.photos/seed/quantum/800/600",
          content: "Квантовые вычисления больше не ограничиваются исследовательскими лабораториями. В этом месяце крупные облачные провайдеры объявили об общей доступности квантовых вычислений как сервиса (QaaS). Это позволяет предприятиям запускать сложные алгоритмы оптимизации и моделировать молекулярные структуры со скоростью, которая ранее считалась невозможной. Хотя мы все еще находимся на ранних стадиях 'квантовой эры', последствия для криптографии, финансового моделирования и открытия лекарств глубоки."
        },
        {
          id: 4,
          title: "Кибербезопасность: Мандат Zero-Trust",
          excerpt: "С ростом изощренных фишинговых атак архитектура Zero-Trust стала требованием для всех предприятий.",
          date: "25 марта 2026 г.",
          category: "Безопасность",
          image: "https://picsum.photos/seed/security/800/600",
          content: "В эпоху, когда безопасности на основе периметра уже недостаточно, архитектура Zero-Trust стала золотым стандартом. Принцип 'никогда не доверяй, всегда проверяй' теперь применяется на каждом уровне корпоративного стека. От биометрических аппаратных ключей до обнаружения аномалий на основе ИИ — компании вкладывают значительные средства в защиту своих данных в условиях все более враждебной цифровой среды. Desknet гарантирует, что все его проверенные инженеры обучены последним протоколам безопасности для поддержания этого стандарта."
        }
      ]
    }
  },
...
6. Sizning huquqlaringiz: Siz istalgan vaqtda hisob sozlamalari orqali shaxsiy ma'lumotlaringizga kirish, ularni tuzatish yoki o'chirish huquqiga egasiz.`
      ...
      cookies: {
        ...
        lastUpdated: "Oxirgi yangilanish: Oktyabr 2023",
        content: `Ushbu Cookie-fayllar siyosati Desknet bizning platformamizga tashrif buyurganingizda sizni tanib olish uchun cookie-fayllar va shunga o'xshash texnologiyalardan qanday foydalanishini tushuntiradi.

1. Cookie-fayllar nima? Cookie-fayllar - bu veb-saytga tashrif buyurganingizda kompyuteringiz yoki mobil qurilmangizga joylashtiriladigan kichik ma'lumotlar fayllari. Ular veb-sayt egalari tomonidan o'z veb-saytlarining ishlashini ta'minlash yoki samaraliroq ishlashi uchun, shuningdek hisobot ma'molotlarini taqdim etish uchun keng qo'llaniladi.

2. Nima uchun biz cookie-fayllardan foydalanamiz? Biz birinchi va uchinchi tomon cookie-fayllaridan bir necha sabablarga ko'ra foydalanamiz. Ba'zi cookie-fayllar platformamiz ishlashi uchun texnik sabablarga ko'ra talab qilinadi va biz ularni "muhim" yoki "qat'iy zarur" cookie-fayllar deb ataymiz. Boshqa cookie-fayllar ham platformamizdagi tajribani yaxshilash uchun foydalanuvchilarimizning qiziqishlarini kuzatish va maqsadli yo'naltirish imkonini beradi.

3. Biz foydalanadigan cookie-fayllar turlari:
- Muhim cookie-fayllar: Platformamiz orqali sizga taqdim etiladigan xizmatlarni ko'rsatish uchun qat'iy zarur.
- Samaradorlik va funksionallik cookie-fayllari: Platformamizning samaradorligi va funksionalligini oshirish uchun foydalaniladi, ammo ulardan foydalanish majburiy emas.
- Tahliliy va moslashtirish cookie-fayllari: Platformamizdan qanday foydalanilayotganini yoki marketing kampaniyalarimiz qanchalik samarali ekanligini tushunishga yordam berish uchun umumiy shaklda foydalaniladigan ma'lumotlarni to'playdi.

4. Cookie-fayllarni qanday boshqarishim mumkin? Siz cookie-fayllarni qabul qilish yoki rad etishni hal qilish huquqiga egasiz. Cookie-fayllarni qabul qilish yoki rad etish uchun veb-brauzeringiz sozlamalarini o'rnatishingiz yoki o'zgartirishingiz mumkin. Agar siz cookie-fayllarni rad etishni tanlasangiz ham veb-saytimizdan foydalanishingiz mumkin, ammo veb-saytimizning ba'zi funksiyalari va bo'limlariga kirishingiz cheklangan bo'lishi mumkin.`
      },
      agreeText: "Men",
      andText: "va",
    ...
    news: {
      tag: "So'nggi Yangiliklar",
      title: "IT Yangiliklari va",
      titleAccent: "Tahlillar",
      subtitle: "Texnologiya va global IT iste'dodlari dunyosidagi so'nggi tendentsiyalar, yutuqlar va tushunchalardan xabardor bo'ling.",
      ...
      categories: {
        ...
        security: "Xavfsizlik",
        cloud: "Bulutli hisoblash"
      },
      items: [
        {
          id: 1,
          title: "AI yutug'i: Avtonom kodlash agentlari",
          excerpt: "Yangi AI modellari endi murakkab dasturiy ta'minot arxitekturasi vazifalarini bajara oladi va ishlab chiqish vaqtini 40% ga qisqartiradi.",
          date: "5-aprel, 2026-yil",
          category: "AI va ML",
          image: "https://picsum.photos/seed/ai-coding/800/600",
          content: "Dasturiy ta'minotni ishlab chiqish manzarasi avtonom kodlash agentlarining joriy etilishi bilan keskin o'zgarishlarga duch kelmoqda. Ushbu ilg'or AI modellari nafaqat kod parchalarini taklif qiladi; ular butun loyiha arxitekturasini tushunishi, eski tizimlarni refaktor qilishi va hatto inson ishlab chiquvchilari o'tkazib yuborishi mumkin bo'lgan murakkab xatolarni tuzatishi mumkin. Sanoat ekspertlarining bashorat qilishicha, 2027-yilga kelib odatiy kodlash vazifalarining 60 foizidan ortig'i ushbu AI yordamchilari tomonidan amalga oshiriladi, bu esa inson muhandislariga yuqori darajadagi dizayn va strategik muammolarni hal qilishga e'tibor qaratish imkonini beradi."
        },
        {
          id: 2,
          title: "2026-yilda Global masofaviy ishning kelajagi",
          excerpt: "Masofaviy ish 'Global First' yondashuviga aylandi, bu erda iste'dodning joylashuvi mahorat va madaniy moslikdan keyin ikkinchi darajali hisoblanadi.",
          date: "2-aprel, 2026-yil",
          category: "Masofaviy ish",
          image: "https://picsum.photos/seed/remote-work/800/600",
          content: "2026-yilga qarab borar ekanmiz, 'masofaviy ish' tushunchasi murakkab 'Global First' strategiyasiga aylandi. Kompaniyalar endi nafaqat xarajatlarni tejash uchun masofadan ishga yollamaydilar; ular buni chegaralardan qat'i nazar, mutlaqo eng yaxshi iste'dodlarga kirish uchun qilmoqdalar. Desknet-ning so'nggi ma'lumotlari qit'alararo muhandislik guruhlarining 45 foizga o'sganligini ko'rsatmoqda. Ushbu muhitda muvaffaqiyat kaliti asinxron aloqa va vaqt zonalari orasidagi bo'shliqni bartaraf etadigan mustahkam raqamli infratuzilmadir."
        },
        {
          id: 3,
          title: "Kvant hisoblash bulutga keldi",
          excerpt: "Yirik bulutli provayderlar endi kvant hisoblashni xizmat sifatida taklif qilmoqdalar, bu kriptografiya va optimallashtirish uchun yangi eshiklarni ochmoqda.",
          date: "28-mart, 2026-yil",
          category: "Bulutli hisoblash",
          image: "https://picsum.photos/seed/quantum/800/600",
          content: "Kvant hisoblash endi faqat tadqiqot laboratoriyalari bilan cheklanib qolmaydi. Shu oyda yirik bulutli provayderlar kvant-as-a-service (QaaS) ning umumiy foydalanish imkoniyatini e'lon qilishdi. Bu korxonalarga murakkab optimallashtirish algoritmlarini ishga tushirish va molekulyar tuzilmalarni ilgari imkonsiz deb hisoblangan tezlikda simulyatsiya qilish imkonini beradi. Biz hali 'Kvant davri'ning boshlang'ich bosqichida bo'lsak-da, kriptografiya, moliyaviy modellashtirish va dori-darmonlarni kashf qilish uchun oqibatlari chuqurdir."
        },
        {
          id: 4,
          title: "Kiberxavfsizlik: Zero-Trust mandati",
          excerpt: "Murakkab fishing hujumlarining kuchayishi bilan Zero-Trust arxitekturasi barcha korxonalar uchun talabga aylandi.",
          date: "25-mart, 2026-yil",
          category: "Xavfsizlik",
          image: "https://picsum.photos/seed/security/800/600",
          content: "Perimetrga asoslangan xavfsizlik endi etarli bo'lmagan davrda Zero-Trust arxitekturasi oltin standart sifatida paydo bo'ldi. 'Hech qachon ishonma, har doim tekshir' printsipi endi korxona stekining har bir qatlamida qo'llanilmoqda. Biometrik apparat kalitlaridan tortib AI asosidagi anomaliyalarni aniqlashgacha, kompaniyalar tobora dushmanona raqamli muhitda o'z ma'lumotlarini himoya qilish uchun katta sarmoya kiritmoqdalar. Desknet barcha tasdiqlangan muhandislarining ushbu standartni saqlab qolish uchun so'nggi xavfsizlik protokollari bo'yicha o'qitilishini ta'minlaydi."
        }
      ]
    }
  }
